...
SORT_KEYS = {
    ...
    'original': None  # Preserve existing order
}


def sort_playlist(playlist, key, descending=False, dry_run=False, backup=False):
...
def main():
    ...
    sort_playlist(playlist, args.sort, args.desc, args.dry_run, args.backup)
